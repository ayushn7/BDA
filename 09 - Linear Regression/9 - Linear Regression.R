# Linear Regression
income_input = as.data.frame(  read.csv("E:\\College Files\\MSC.IT PART 1 SEM 2\\PRACTICAL CODES\\Big Data Analytics\\09 - Linear Regression\\Data Sets\\income.csv")   )
income_input[1:10,]
...
splom(~income_input[c(2:5)],  groups=NULL, data=income_input, 
      axis.line.tck = 0,
      axis.text.alpha = 0)
# Can use pairs() as used in earlier practical
